...
ClientHandler::ClientHandler(CursesHelper *cursesHelper, Room *room, int serverDescriptor)
        : cursesHelper(cursesHelper), room(room), PollHelper(cursesHelper, serverDescriptor, room->slots + 1) {}

std::string ClientHandler::handleClientMessage(int descriptor, std::string message) {
